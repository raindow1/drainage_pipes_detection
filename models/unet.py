...
class UNetSM(nn.Module):
    """U-Net архитектура для семантической сегментации с сигмоидой на выходе"""
    ...
    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        ...
        # Выходной слой
        self.conv = nn.Conv2d(in_channels=features, out_channels=out_channels, kernel_size=1)  # 1x1 свертка
    ...
    def forward(self, x):
        ...
        # Выходной слой с сигмоидой (для бинарной сегментации)
        return torch.sigmoid(self.conv(dec1))

    @staticmethod
    def _block(in_channels, features, name):
        """Базовый блок U-Net (две свертки + ReLU + BatchNorm)"""
